...
function EventCardWide({
  ...
  return (
    <button
      ...
      className="flex flex-col rounded-xl bg-white overflow-hidden text-left transition-all hover:shadow-md active:scale-[0.99] group"
      style={{ border: '1px solid rgba(201,168,76,0.35)' }}
    >
      <div className="relative bg-cream-200" style={{ height: '128px' }}>
        ...
        >
          ...
          <span className="text-gold-400 text-[10px] font-bold tracking-wide mt-0.5">
            {monthShort(date)}
          </span>
        </div>
      </div>
      ...
      <div className="p-3 flex flex-col gap-1.5 flex-1">
        ...
        <div className="flex items-center gap-1.5 text-navy-500 text-xs">
          <CalendarDays size={12} className="text-gold-500 flex-shrink-0" />
